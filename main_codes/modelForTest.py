...
test_set_object, test_set_tag, test_set_tag_expected, test_set_title, test_set_description = get_input.test_set("SMALL")
train_set_objects, train_set_tag, train_set_title, train_set_description =get_input.train_set("SMALL")

print(test_set_tag_expected[0:10])
...
def model(part_num, step_size):
    ...
    all_vectors = []
    j = l1 - 1
    for obj, initial_tag,expected, title, desc in zip(test_set_object[l1:l2],
                                                      test_set_tag[l1:l2],
                                                      test_set_tag_expected[l1:l2],
                                                      test_set_title[l1:l2],
                                                      test_set_description[l1:l2]):
    ...
    file_path = "outputsTest/out"+str(part_num)+".txt"
